...
<!-- Page level plugins -->
<script src="<?php echo LIB ?>vendor/chart.js/Chart.min.js"></script>

<!-- Page level custom scripts -->
<script src="<?php echo LIB ?>js/demo/chart-area-demo.js"></script>
<script src="<?php echo LIB ?>js/demo/chart-pie-demo.js"></script>
